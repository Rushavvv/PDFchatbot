...
async def chat_pdf(request: ChatRequest):
    print(request.document_id, request.question, api_key)
    answer = answer_question_gemini(request.document_id, request.question, api_key)
    print("Answer:", answer)
    if not answer:
...
async def summarize(request: SummaryRequest):
    summary = summarize_pdf(request.document_id, api_key)
